package com.example.bookli.introScrean;
...
import com.example.bookli.actitvity.MainActivity;
...
public class InteroScrean extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // to check is app start and save in shared reference if true move to anther page
        if (restorePrefData()) {
        ...
        setContentView(R.layout.activity_intero_screan);
        getSupportActionBar().hide(); //to remove tap par
